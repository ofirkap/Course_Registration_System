...
public class Tests implements Runnable {
    ...
    public String testStudentStat() {
        ...
        System.out.println(ack + " vs: ACK 8" + "\n" +
                studentName + " vs: Student: RON0" + "\n" +
                coursesL + " vs: " + courseList+ "\n");
    ...
    public String testCourseStat() {
        ...
        System.out.println(ack + " vs: ACK 7" + "\n" +
                courseName + " vs: " + "Course: (" + p.getCourseNum() + ") " + p.getCourseName() + "\n" +
                seats + " vs: " + "Seats Available: " + "0/" + numOfThreads + "\n" +
                studentsL + " vs: " + students+ "\n");
    ...
    private static class Course {
        ...
        public void sortKdamCourses() {
            kdamCourses.sort(courseComparator);
        }
